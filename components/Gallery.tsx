...
export const Gallery = () => {
  ...
  const galleryItems = [
    ...
    {
      id: 19,
      image: "/assets/img/portofolio/portfolio-lampu-robyong-dekorasi-joglo-1.jpeg",
      title: "Lampu Robyong Dekorasi Joglo",
      span: "md:col-span-1 md:row-span-1",
    },
    {
      id: 20,
      image: "/assets/img/portofolio/portfolio-lampu-robyong-dekorasi-joglo-2.jpeg",
      title: "Lampu Robyong Dekorasi Joglo",
      span: "md:col-span-1 md:row-span-1",
    },
    {
      id: 21,
      image: "/assets/img/portofolio/portfolio-lampu-gantung-hotel-maxone.jpeg",
